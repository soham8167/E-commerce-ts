...
const [items, setItems] = useState<Product[]>(products);
  ...
  return (
    <div className="flex flex-wrap gap-4 justify-center">
      <h2 className="text-2xl text-green-500">ENJOY OUR SEASONAL FOODS</h2>
      
      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatibus deleniti rerum commodi nemo quaerat voluptas!</p>
      {items.map((item) => (
        <div
          key={item.id}
